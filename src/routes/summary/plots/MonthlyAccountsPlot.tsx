...
const DrawMonthlyAccountsPlot = (props: { data: AssetsDebts[], domain: DateTime[] }) => {
...
export const MonthlyAccountsPlot = (props: { bookId: string, domain: DateTime[]}) => {
    const assetsDebts = useAssetsDebts(props.bookId);
    return <StateHandler dependencies={[assetsDebts]}>
        <DrawMonthlyAccountsPlot data={assetsDebts.data!} domain={props.domain}/>
    </StateHandler>
}
