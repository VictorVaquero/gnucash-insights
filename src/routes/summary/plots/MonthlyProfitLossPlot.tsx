...
const DrawMonthlyProfitLossPlot = (props: { data: ProfitLoss[], domain: DateTime[] }) => {
...
export const MonthlyProfitLossPlot = (props: {bookId: string, domain: DateTime[]}) => {
    const profitLoss = useProfitLoss(props.bookId);
    return <StateHandler dependencies={[profitLoss]}>
        <DrawMonthlyProfitLossPlot data={profitLoss.data!} domain={props.domain}/>
    </StateHandler>
}